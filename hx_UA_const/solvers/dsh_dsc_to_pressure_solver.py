...
class PressureSolver:
    ...
    def solve_evap(self, P_cond: float, T_eva_air: float):
        ...
        h_cond_out, s_cond_out, T_cond_out = self.cond.exchange(mdot, P_cond, h_comp_out)
        h_eva_out, s_eva_out, T_eva_out = self.eva.exchange(mdot, P_eva_sol, h_cond_out)

        return P_eva_sol, h_comp_out, s_comp_out, T_comp_out, h_cond_out, s_cond_out, T_cond_out, h_eva_out, s_eva_out, T_eva_out, mdot
        
    def solve_cond(self, T_cond_air: float, T_eva_air: float):
        def cycle_DSC(P_cond):
            P_eva_sol, h_comp_out, s_comp_out, T_comp_out, h_cond_out, s_cond_out, T_cond_out, h_eva_out, s_eva_out, T_eva_out, mdot = self.solve_evap(P_cond, T_eva_air)
        ...
        P_eva_sol, h_comp_out, s_comp_out, T_comp_out, h_cond_out, s_cond_out, T_cond_out, h_eva_out, s_eva_out, T_eva_out, mdot = self.solve_evap(P_cond_sol, T_eva_air)
